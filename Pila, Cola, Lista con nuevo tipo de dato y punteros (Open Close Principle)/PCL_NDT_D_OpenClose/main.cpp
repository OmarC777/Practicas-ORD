    ...
    do {
        ...
        switch(opcion) {
            ...
            case 4: 
                ...
                else cout << "Estado: NO esta llena (o es dinamica sin limite).\n";
                break;
            case 5: 
...
{
	ListaMaquillaje obMakeup;
    ColaClientes obClientes;
    PilaAlumnos obAlumnos; 
    
    vector<EstructurasDatos*> estructuras = {&obMakeup, &obClientes, &obAlumnos};
